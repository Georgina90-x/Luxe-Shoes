# Luxe Shoes ECommerce Shop
Luxe Shoes is an ecommerce website allowing users to browse and purchase luxury shoes and accessories. Luxe Shoes was developed as part of Milestone Project 4 from Code Institure's Diploma in Software Development. 

- There are two types of users for the Luxe shoes website
...
# Table of Contents
- [Luxe Shoes shop](#luxe-shoes-shop)
...
- The Luxe Shoes website has been stored in a repository on Github and the source code can be accessed here: [Code Repository](https://github.com/Georgina90-x/Luxe-Shoes/tree/main)
